...
// Fixed positions instead of the original Math.random(): random values differ
// between server render and client hydration in Next.js, causing hydration
// mismatches. Same ranges as the original (x: 7-10, y: 1-6).
